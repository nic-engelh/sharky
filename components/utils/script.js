...
function unmuteBackgroundMusic(icon) {
  ...
  icon.src =
    "https://niklas-engelhardt.de/sharky/assets/img/6.Botones/Control/volume_up_FILL0_wght400_GRAD0_opsz24.svg"; // Replace with the path to your unmute icon
...
function muteBackgroundMusic(icon) {
  ...
  icon.src =
    "https://niklas-engelhardt.de/sharky/assets/img/6.Botones/Control/volume_mute_FILL0_wght400_GRAD0_opsz24.svg"; // Replace with the path to your mute icon
