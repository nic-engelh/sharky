class ThrowableObject extends MovableObject {
  ...
  constructor(x, y, poison, direction) {
    super();
    if (poison) 
      this.loadImage("https://niklas-engelhardt.de/sharky/assets/img/1.Sharkie/4.Attack/Bubble trap/Poisoned Bubble (for whale).png");
    if (!poison)
      this.loadImage("https://niklas-engelhardt.de/sharky/assets/img/1.Sharkie/4.Attack/Bubble trap/Bubble.png");
    this.width = 40;
    this.height = 40;
   ...
   */
  changeImage() {
    this.loadImage('https://niklas-engelhardt.de/sharky/assets/img/2.Enemy/2 Jelly fish/Dead/Yellow/y1.png');
  } 
