class Hero extends MovableObject {
  imagesWalking = [
    "https://niklas-engelhardt.de/sharky/assets/img/1.Sharkie/3.Swim/1.png",
    "https://niklas-engelhardt.de/sharky/assets/img/1.Sharkie/3.Swim/2.png",
    "https://niklas-engelhardt.de/sharky/assets/img/1.Sharkie/3.Swim/3.png",
    "https://niklas-engelhardt.de/sharky/assets/img/1.Sharkie/3.Swim/4.png",
    "https://niklas-engelhardt.de/sharky/assets/img/1.Sharkie/3.Swim/5.png",
    "https://niklas-engelhardt.de/sharky/assets/img/1.Sharkie/3.Swim/6.png",
  ];
